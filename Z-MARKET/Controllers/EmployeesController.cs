...
namespace Z_MARKET.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,Salary,BonusPercent,DateOfBirth,StarTime,Email,URL,DocumentTypeID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,Salary,BonusPercent,DateOfBirth,StarTime,Email,URL,DocumentTypeID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
