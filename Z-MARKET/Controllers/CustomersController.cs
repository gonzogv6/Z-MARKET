...
namespace Z_MARKET.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,FirstName,LastName,Phone,Adress,Email,Document,DocumentTypeID")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,FirstName,LastName,Phone,Adress,Email,Document,DocumentTypeID")] Customer customer)
        {
            if (ModelState.IsValid)
            {
